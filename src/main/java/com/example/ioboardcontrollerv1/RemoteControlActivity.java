...
public class RemoteControlActivity extends AppCompatActivity
{
    ...
    private class ExtendedModuleHelper extends ModuleHelper
    {
        ...
        {
            List<ModuleTab> tablist = new ArrayList<ModuleTab>();
    ...
    */
    ...
    public class ImgButtonLoginClickListener implements View.OnClickListener
    {
        @Override
        public void onClick(View arg0)
        {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        ImgButtonLoginClickListener iblcl = new ImgButtonLoginClickListener();
        imagebuttonLogin.setOnClickListener(iblcl);
        */
    }
